...
//
//   // SQLite doesn't support boolean. Use INTEGER/BIT (0/1 values).
//   final bool isDone;
//
//   // SQLite doesn't support DateTime. Store them as INTEGER (millisSinceEpoch).
...
//     _todos = jsons.map((json) => TodoItem.fromJsonMap(json)).toList();
//   }
//
